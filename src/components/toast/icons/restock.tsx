...
const id = `restock_${shortid.generate()}`;
const Icon: React.FunctionComponent<any> = ({ title, desc, fillColor, ...props }: {title: string, desc: string, fillColor: string}) => {
  return (
    <svg
      id={id}
      {...props}
